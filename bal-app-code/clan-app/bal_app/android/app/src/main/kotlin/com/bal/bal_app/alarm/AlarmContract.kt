...
object AlarmContract {
    ...
    // ── أوامر Intent ───────────────────────────────────────
    const val ACTION_ALARM_FIRE = "com.bal.bal_app.alarm.ACTION_FIRE"
    const val ACTION_ALARM_DISMISS = "com.bal.bal_app.alarm.ACTION_DISMISS"
    const val ACTION_ALARM_SNOOZE = "com.bal.bal_app.alarm.ACTION_SNOOZE"

    /** يُبثّ داخلياً ليعرف الـ JS أن المنبه رنّ */
    const val ACTION_ALARM_RINGING_EVENT = "com.bal.bal_app.alarm.EVENT_RINGING"
